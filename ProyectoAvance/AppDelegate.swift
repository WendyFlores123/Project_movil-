...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func mostrarCuadroDialogo(titulo : String, mensaje: String, vista: UIViewController){
        ...
        vista.present(ventana, animated: true, completion: nil)
    }


    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        // Override point for customization after application launch.SDF
        return true
    }
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "ProyectoAvance")
